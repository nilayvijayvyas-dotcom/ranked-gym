...
// Form submission handler for Log Workout page
function setupLogWorkoutForm() {
    ...
    if (form) {
        form.onsubmit = function (e) {
            ...
            // Correct way to gather form data
            ...
            // Save workout (correct function name)
            addWorkout(data);

            // Update Personal Best for the muscle selected
